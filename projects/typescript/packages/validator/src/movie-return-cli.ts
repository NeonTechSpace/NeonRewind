...
const schemaIds = {
  observation: "urn:neonrewind:schema:runtime:movie-return-observation:1",
  mechanics: "urn:neonrewind:schema:domain:movie-return-mechanics:4",
  report: "urn:neonrewind:schema:validation:movie-return-validation:1",
} as const;
