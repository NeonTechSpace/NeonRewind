...
function writeUsage(stream: NodeJS.WritableStream): void {
  ...
  stream.write(
    "  neonrewind-data-compiler movie-return-mechanics --rental-evidence <path> --rental-evidence-schema <schema> --blueprint-bodies <path> --blueprint-bodies-schema <schema> --output <path>\n",
  );
}
