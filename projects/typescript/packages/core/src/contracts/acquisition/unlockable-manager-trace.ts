import type { UnlockableManagerTraceContract } from "../generated/acquisition/unlockable-manager-trace.ts";
import { defineArtifactSchema } from "../define-artifact-schema.ts";

export const UnlockableManagerTraceJsonSchema = {
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "urn:neonretrorewind:schema:acquisition:unlockable-manager-trace",
  "title": "NeonRetroRewind unlockable manager trace",
  "type": "object",
...
export const UnlockableManagerTraceSchema = defineArtifactSchema<UnlockableManagerTraceContract>(UnlockableManagerTraceJsonSchema);
