import type { StructuredAssetIndexContract } from "../generated/acquisition/structured-asset-index.ts";
import { defineArtifactSchema } from "../define-artifact-schema.ts";

export const StructuredAssetIndexJsonSchema = {
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "urn:neonretrorewind:schema:acquisition:structured-asset-index",
  "title": "NeonRetroRewind structured asset index",
  "type": "object",
...
export const StructuredAssetIndexSchema = defineArtifactSchema<StructuredAssetIndexContract>(StructuredAssetIndexJsonSchema);
