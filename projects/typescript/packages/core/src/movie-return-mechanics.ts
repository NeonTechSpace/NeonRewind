...
export interface BlueprintTraceEvidence {
  ...
  readonly eventGraphFunction: "ExecuteUbergraph_AI_Client_Character";
  readonly customerFunction: "Initial creation - Get if I have Product to return";
...
export interface RentalReadinessTraceEvidence {
  ...
  readonly classPath: string;
  readonly newDayFunction: "Weather - New Day Event";
  readonly readinessFunction: "Get Movie ready for return";
  readonly eventGraphFunction: "ExecuteUbergraph_RentSystem";
  readonly statementIndexes: {
...
export interface RentalSelectionTraceEvidence {
  readonly artifactType: "rental-function-trace";
  readonly classPath: string;
  readonly functionName: "Get Random List Of Cartridges From Rent List";
  readonly statementIndexes: {
