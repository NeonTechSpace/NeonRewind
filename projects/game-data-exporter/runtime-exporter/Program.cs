...
internal static class Program
{
    ...
    private static void WriteUsage(TextWriter writer)
    {
        ...
        writer.WriteLine("  NeonRewind.RuntimeExporter stage-probe --ue4ss-archive <path> --build-manifest <path> --game-executable <path> --probe-script <path> --output <new-directory>");
        writer.WriteLine("  NeonRewind.RuntimeExporter install-probe --staging-manifest <path> [--approve-staging-sha256 <sha256>]");
        writer.WriteLine("  NeonRewind.RuntimeExporter cleanup-probe --installation-manifest <path> [--approve-installation-sha256 <sha256>]");
        writer.WriteLine();
