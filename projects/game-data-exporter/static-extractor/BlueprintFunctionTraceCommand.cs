...
internal static class BlueprintFunctionTraceCommand
{
    ...
    {
        writer.WriteLine("Usage: NeonRetroRewind.StaticExtractor blueprint-function-trace --build-manifest <path> --caller-bodies <path> [--caller-bodies <path> ...] --mappings <path> --package-directory <path> --output <path>");
        writer.WriteLine();
