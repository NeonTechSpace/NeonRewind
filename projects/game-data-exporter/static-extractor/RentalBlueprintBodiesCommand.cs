...
internal static class RentalBlueprintBodiesCommand
{
    ...
    private static readonly IReadOnlyDictionary<string, string> ExpectedClasses =
        ...
        {
            ["RetroRewind/Content/VideoStore/core/ai/Task/BTTask_BringBackProductFromRent.uasset"] =
                "BTTask_BringBackProductFromRent_C",
            ["RetroRewind/Content/VideoStore/core/ai/Task/BTTask_Checkout-Fees.uasset"] =
                "BTTask_Checkout-Fees_C",
            ["RetroRewind/Content/VideoStore/core/ai/Task/BTTask_Checkout-Pay.uasset"] =
                "BTTask_Checkout-Pay_C",
    ...
    {
        writer.WriteLine("Usage: NeonRewind.StaticExtractor rental-blueprint-bodies --build-manifest <path> --rental-evidence <path> --mappings <path> --package-directory <path> --output <path>");
        writer.WriteLine();
