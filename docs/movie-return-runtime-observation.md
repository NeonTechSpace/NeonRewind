...
The `@neonrewind/validator` package checks event ordering, time bounds, queue transfer, selector membership, and customer inventory and queue transitions after schema validation.
