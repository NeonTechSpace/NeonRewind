...
| Stable NeonRetroRewind research records | Film catalog, console-return, membership-fee, movie-return, new-release, level-progression, daily movie Market, Market value, Market guide-findings, checkout-income, Market rental-economics, and customer-shopping compilers exist |
...
| Customer shopping mechanics | A private compiler records arrival, selection, pickup, conditional cart-completion, failure, and rental-registration rules while keeping visit conversion and recommendation claims unsupported |
