...
The structured-index, structured-values, rental-evidence, and rental-blueprint-bodies commands also require a `.usmap` mapping produced for the exact game executable recorded in the build manifest.
