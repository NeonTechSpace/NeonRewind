...
The structured-index, structured-values, rental-evidence, rental-blueprint-bodies, and blueprint-call-sites commands also require a `.usmap` mapping produced for the exact game executable recorded in the build manifest.
