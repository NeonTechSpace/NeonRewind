...
```powershell
dotnet run --project projects/game-data-exporter/static-extractor/NeonRetroRewind.StaticExtractor.csproj -- <package-directory>
```
...
```powershell
dotnet run --project projects/game-data-exporter/static-extractor/NeonRetroRewind.StaticExtractor.csproj -- manifest --steam-manifest <path> --executable <path> --package <path> --output <path>
```
...
```powershell
dotnet run --project projects/game-data-exporter/static-extractor/NeonRetroRewind.StaticExtractor.csproj -- structured-values --build-manifest <path> --structured-index <path> --mappings <path> --package-directory <path> --output <path>
```
